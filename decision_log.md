...
## 12:05–12:13 — Brazo SHORT (B.4): 4 espejos bear en futuros Binance
- Contexto: dar al selector un brazo bajista. Klines perp públicas de Binance (mark + funding reales), freqtrade FUTURES MODE en CT 113, fee 0.001, 9 pares `:USDT`, `can_short`. Smoke VolBreakoutShort 2021 OK (87 trades). Commit `8c139f6` (strategies `*_short.py`, configs futures con `use_order_book: true`).
